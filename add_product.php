...
<?php
 if(isset($_POST['add_vehicle'])){
   $req_fields = array('vehicle-station','vehicle-reg','vehicle-date','vehicle-class','vehicle-makermodel','vehicle-engine','vehicle-chasis', 'vehicle-o','vehicle-cat' );
   ...
   if(empty($errors)){
     ...
     $p_cat  = remove_junk($db->escape($_POST['vehicle-cat']));
     ...
     $query .=") VALUES (";
     $query .=" '{$p_st}', '{$p_reg}', '{$p_date}', '{$p_class}', '{$p_makermodel}', '{$p_eng}', '{$p_cha}', '{$p_o}','{$p_cat}'";
     $query .=")";
               ...
               <div class="row">
                 <div class="col-md-4">
                   <div class="input-group">
                     ...
                     <input type="number" class="form-control" name="vehicle" placeholder="Product Quantity">
                  </div>
                 </div>
                 <div class="col-md-4">
                   <div class="input-group">
