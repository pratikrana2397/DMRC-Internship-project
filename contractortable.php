...
<form  style="display:none;" action="contractortable.php" method="post">
...
<table id="table" style="border-color: black; border-width: 3px;" class="table table-striped table-advance table-hover tablesorter”">
                              ...
                              <tr style="border-color:  black;background-color: #4c4c4c; color: #fff; font-size: 15px ; border-width: 3px;" >
                                  ...
                                  <th style="border-color: lightpink; border-width: 3px;background-color: lightpink;width: 15%;"    >line</th>
                                  
                                  <th style="border-color: lightblue; border-width: 3px; background-color: lightblue;width: 15%;"   height='30'>Station</th>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>You sure want to delete contractor no-><label id="removevehicleno"></label>?</p>
        </div>
 ...
 <form action="contractortable.php" method="POST">
...
$('#excelfile').attr('title', '');
 ...
 filename:'ContractorTable '+newStr, 
 title:'',
            },
 ...
 $str='DELETE FROM `stationinfo` WHERE 1;INSERT INTO `stationinfo`(`line`, `station`, `Stationcode`, `contractor`, `contractorinfo`)VALUES';
