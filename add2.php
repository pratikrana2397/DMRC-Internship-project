...
$_SESSION['line']="*";
       $_SESSION['station']="";
       $_SESSION['contractorname']="";
       $_SESSION['contractorinfo']=""; 
       $_SESSION['code3']="";
...
$_SESSION['lineerror']=$_POST['dummyerrorline'];
...

    {
     ...
     while ($row = mysqli_fetch_array($result4)) {
       ...
       $query='INSERT INTO `stationinfo`(`stationuniqueno`, `line`, `station`, `Stationcode`, `contractor`, `contractorinfo`) VALUES ("'.$no.'","'.$_POST["line"].'","'.$_POST["station"].'","'.$stationcode.'","'.$_POST["contractorname"].'","'.$_POST["contractorinfoname"].'")';
       $result= mysqli_query($db, $query);
...
<div class="container">
 <h1><u>Add Contractor</u></h1><br><br>
