...
session_start(); 
 if (isset($_POST['submit'])) {
  ...
  if (isset($_POST['hiddensubmit2'])) {
    ...
    $db = mysqli_connect('localhost', 'root', '', 'dmrc_park');
 $query='DELETE FROM `users` WHERE `stationid`="'.$_POST["uniqueno2"].'"';
  ...
  $result= mysqli_query($db, $query);
   ...
   while ($row=mysqli_fetch_array($result)) {
   		$code.= '<tr >
       	     ...
       	     <td  class="noclass" style="font-size:15px; font-family:"Times New Roman", Times, serif;"align="center">'.$row["stationid"].'</td>
             <td  style="font-size:15px; font-family:"Times New Roman", Times, serif;"align="center">'.$row["password"].'</td>
...
<form  style="display:none;" action="usertable.php" method="post">
...
<table id="table" style="border-color: black; border-width: 3px;" class="table table-striped table-advance table-hover tablesorter”">
                              ...
                              <tr style="border-color:  black;background-color: #4c4c4c; color: #fff; font-size: 15px ; border-width: 3px;" >
                                  ...
                                  <th style="border-color: black; border-width: 3px;background-color: lightpink;width: 15%;"    >StationId</th>
                                  
                                  <th style="border-color: black; border-width: 3px; background-color: lightblue;width: 15%;"   height='30'>Password</th>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>You sure want to user-><label id="removevehicleno"></label>?</p>
        </div>
 ...
 $str='DELETE FROM `users` WHERE 1;INSERT INTO users (stationid,password)VALUES';
