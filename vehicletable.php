...
if (isset($_POST['submit'])) {
  ...
  if (isset($_POST['hiddensubmit'])) {
     $_SESSION['vehicleno'] =  $_POST['uniqueno'];
  ...
  if (isset($_POST['hiddensubmit2'])) {
     ...
     $db = mysqli_connect('localhost', 'root', '', 'dmrc_park');
 $query='DELETE FROM `vehicledata` WHERE `vehicleno`="'.$_POST["uniqueno2"].'"';
...
<form  style="display:none;" action="vehicletable.php" method="post">
...
<table id="table" style="border-color: black; border-width: 3px;" class="table table-striped table-advance table-hover tablesorter”">
                              <thead >
                              <tr style="border-color:  black;background-color: #4c4c4c; color: #fff; font-size: 15px ; border-width: 3px;height:10px;" >
                              	
                              	 <!-- <th style="border-color: black; border-width: 3px;background-color: black;width: 1%;"    >#</th>-->
                              	 
                                  <th style="border-color: black; border-width: 3px;background-color: lightpink;width: 15%;"    >Type</th>
                                  
                                  <th style="border-color: black; border-width: 3px; background-color: lightblue;width: 15%;"   height='40'>Make</th>
                                  <th style="border-color: black; border-width: 3px; background-color: orange;width: 15%; "  >Model</th>
                                 <!-- <th style="border-color: black; border-width: 3px;background-color: royalblue;width: 10%;"    >Action</th>-->
                              </tr>
...
$('#excelfile').attr('title', '');
 ...
 title:'',
 	 ...
 	 function editbutfun()
 	 {
        ...
        for(var i=0;i<x.length;i++)
        {
          if(x[i].checked==true)
           {
           	console.log(x[i].value+"sdhcsh");
            $('#uniquenum').val(x[i].value);
    // Let's test it out
            $('#submitbut').trigger('click');
            break;
           }
 	 ...
 	 function removedatafun1()
 	 {
        ...
        for(var i=0;i<x.length;i++)
        {
          if(x[i].checked==true)
           {
           	console.log(x[i].value+"sdhcsh");
           	 document.getElementById('removevehicleno').innerHTML=x[i].value;
    // Let's test it out
 	 ...
 	 console.log("iminside exporttotable");  
 ...
 $str='DELETE FROM `vehicledata` WHERE 1;INSERT INTO vehicledata (`Type`, `Make`, `Model`)VALUES';
