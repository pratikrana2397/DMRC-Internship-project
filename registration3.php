   ...
   if(($_POST["dummytext"]!=''||$_POST["dummytext2"]!=''||$_POST["dummytext3"]!=''||$_POST["dummytext4"]!=''))
   {
    ...
    if($check !== false){
        ...
        $originalDate = $_POST["parkedsince"];
         ...
         $_SESSION['reg']='';
         $query0='INSERT INTO `data`(`No`, `Line`, `Station`, `Contractor`, `ParkedSince`, `Type`, `Make`, `Model`, `Reg.No.`, `EngineNo`, `ChassisNo`, `color`, `CarNameplatePhoto`, `CarFrontPhoto`, `CarBackPhoto`, `CarLeftPhoto`, `CarRightPhoto`,`otheritems`, `remarks`) VALUES ("'.$no.'","'.$_POST["line"].'","'.$_POST["station"].'","'.$_POST["contractor"].'","'.$newDate.'","'.$type.'","'.$make.'","'.$model.'","'.$_POST["registrationno"].'","'.$_POST["enginenumber"].'","'.$_POST["chassinumber"].'","'.$_POST["favcolor"].'","'.$imgContent0.'","'.$imgContent1.'","'.$imgContent2.'","'.$imgContent3.'","'.$imgContent4.'","'.$_POST["extrathings"].'","'.$_POST["remarks"].'")';
         //echo $query0;
