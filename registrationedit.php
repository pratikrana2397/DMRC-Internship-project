...
<body style="background-color: #8a8a5c;" onload="showtype();showcontractor();showcolor();showmake('<?php echo $type?>');showmodel('<?php echo $make?>');">
  ...
  <div class="container-fluid" style="background-color:#0099ff;">
    ...
    <div class="navbar-header" style="height:50px;margin-bottom: 10px;">
     ...
     <br>
	<div class='container' style="background-color:#c1f0c1;border-radius: 10px;border:3px solid #cecece;vertical-align: middle;">
    <div class="row">
...
<form action="registrationedit.php" id="myform" method="post" enctype="multipart/form-data">
    <br><br>
